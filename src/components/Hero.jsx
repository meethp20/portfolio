        ...
        <main className="container mx-auto px-6 py-8">
          <section className="my-8">
            ...
            <p className={`mt-4 font-serif italic text-lg ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
              I'm a second-year Computer Science graduate student passionate about web development and blockchain technology. 
            ...
            <p className={`mt-4 font-serif italic text-lg ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
              Currently exploring the exciting world of Web3 and blockchain development, combining my CS background with cutting-edge decentralized technologies.
            </p>
          </section>
        </main>
    </div>
